...
export const WebServicesSchema = () => {
  useEffect(() => {
    const schema = {
      ...
      description: 'Desarrollo de páginas web profesionales: portfolios, blogs, e-commerce, landing pages y sitios institucionales.',
        ...
        itemListElement: [
          ...
          },
          {
            ...
            itemOffered: {
              ...
              description: 'Plataforma institucional con múltiples secciones y funcionalidades',
            },
          },
        ],
      },

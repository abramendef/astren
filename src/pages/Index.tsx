...
const Index = () => {
  useSEO({
    ...
    keywords: "astren, tecnología, software, páginas web, invitaciones digitales, desarrollo web, e-commerce, AstrenGPR, AstrenAI, AstrenGames, Mazatlán, Sinaloa, México",

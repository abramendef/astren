...
const ServicesIndex = () => {
  useSEO({
    ...
    description: "Creamos páginas web profesionales e invitaciones digitales personalizadas para clientes en todo México y el mundo. Trabajo 100% remoto. Desarrollo web, e-commerce, landing pages, invitaciones para bodas, XV años y eventos. Invitaciones desde $600 MXN.",
